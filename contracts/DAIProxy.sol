...
contract DAIProxy {
    ...
    function fund(address loanAddress, address lender, uint256 fundingAmount) public onlyKYCanDeposit {
        require(DAIToken.approve(lender, fundingAmount), 'funding not approved'); // is this needed?
        balance = DAIToken.balanceOf(lender);
    ...
    function repay(address loanAddress, address originator, uint256 repaymentAmount) public {
        ...
        balance = DAIToken.balanceOf(loanAddress);
